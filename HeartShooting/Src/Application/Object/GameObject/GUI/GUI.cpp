...
void GUI::DrawNowWave()
{
	...
	case 1:
		rc = { 0,16,9 * 7,16 };
		KdShaderManager::Instance().m_spriteShader.DrawTex(m_spWaveTex, 460, 180, 27 * 7, 45, &rc);
		break;
	case 2:
		rc = { 0,32,9 * 4,15 };
		KdShaderManager::Instance().m_spriteShader.DrawTex(m_spWaveTex, 460, 180, 27 * 4, 45, &rc);
		break;
	case 3:
		rc = { 0,48,9 * 5,15 };
		KdShaderManager::Instance().m_spriteShader.DrawTex(m_spWaveTex, 460, 180, 27 * 5, 45, &rc);
		break;
	}
}
